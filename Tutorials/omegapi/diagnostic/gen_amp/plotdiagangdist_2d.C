...
void plotdiagangdist_2d() {
  char STRING[256];
    sprintf(STRING,"gen_amp_diagnostic.root");
...
//   gStyle->SetTitleSize(0.065,"xy");
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   q5->cd(1);
     ...
     M_isobar->GetXaxis()->SetRangeUser(0.3, 2.0);
    ...
    M_Phi_Prod->GetXaxis()->SetRangeUser(0.5, 2.0);
   ...
   M_CosTheta->GetXaxis()->SetRangeUser(0.5, 2.0);
   ...
   M_Phi->GetXaxis()->SetRangeUser(0.5, 2.0);
     ...
     M_CosThetaH->GetXaxis()->SetRangeUser(0.5, 2.0);
    ...
    M_PhiH->GetXaxis()->SetRangeUser(0.5, 2.0);
